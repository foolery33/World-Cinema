...
//        setupButtonsStackView()
    ...
    private lazy var label: UILabel = {
        ...
        label.text = ";lkjasd;flkjasd;flkjasd;flkjasd;lfkjasdf;lkjlkasjdhfadfasdfasdf"
        return label
    }()
    ...
    private func setupButtonsStackView() {
        ...
        buttonsStackView.snp.makeConstraints { make in
            make.bottom.equalTo(view.safeAreaLayoutGuide.snp.bottom).offset(-Paddings.betweenBottomAndLogin)
